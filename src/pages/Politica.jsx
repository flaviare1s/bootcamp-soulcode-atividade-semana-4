      ...
      <Container fluid>
        <Tabs defaultActiveKey="sobre" id="uncontrolled-tab-example" className="mb-3">
          <Tab eventKey="sobre" title="Sobre">
            ...
            <p>Bem-vindo ao Adote um Amor, sua plataforma de adoção de pets. A sua privacidade é importante para nós. Esta Política de Privacidade explica como coletamos, usamos, divulgamos e protegemos suas informações quando você utiliza nosso site e serviços.</p>
            ...
            <ol>
              ...
              <ol>
                ...
                <p>Coletamos informações sobre como você usa nosso site e serviços, incluindo os pets que você visualiza, favoritos que adiciona e interações com nossa plataforma.</p>
          ...
          <Tab eventKey="contato" title="Contato">
            ...
            <p>Obrigado por escolher o Adote um Amor. Estamos comprometidos em proteger sua privacidade e fornecer um serviço seguro e confiável.</p>
          </Tab>
        </Tabs>
      </Container>
    </section>
